...
![presentacion](img/fun.png){: .center}
...
![logotipo](img/migasfree.svg){: .center style="height=20%;width:20%;"}
...
### [Parte 1. Introducción](part1/index.md)
...
A Jose Antonio Chavarría, compañero de fatigas (y alegrías), también me
